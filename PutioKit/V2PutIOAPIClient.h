...
- (void)requestTorrentOrMagnetURL:(NSURL *)URL toFolder:(PKFolder *)folder callback:(void(^)(id userInfoObject))onComplete addFailure:(void (^)())onAddFailure networkFailure:(void (^)(NSError *error))failure;
